<template>
  <div>
    <div v-for="(i, k) in data" :key="k">
      <div v-html="i.innerHTML" data-aos="fade-up" v-if="i.innerBlocks.length === 0" />
      <div v-html="i.innerHTML" data-aos="fade-up" v-else-if="i.blockName === `core/media-text`" />
      <div data-aos="fade-up" v-else-if="i.blockName === `core/columns`">
